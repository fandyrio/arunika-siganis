...
// Route::get('logout', 'loginController@logout')->name('logout')->middleware('cas.auth');
...
Route::post('edit-pertanyaan', 'configController@editPertanyaan')->name('edit-pertanyaan')->middleware('cas.auth');
Route::post('update-pertanyaan', 'configController@updatePertanyaan')->name('update-pertanyaan')->middleware('cas.auth');
...
Route::post('form-kembalikan-artikel', 'artikelController@formKembalikanArtikel')->name('form-kembalikan-artikel')->middleware('cas.auth');
Route::get('list-artikel-dikembalikan-jm', 'artikelController@listArtikelDikembalikan')->name('list-artikel-dikembalikan')->middleware('cas.auth');
Route::post('save-pengembalian', 'artikelController@savePengembalian')->name('save-pengembalian')->middleware('cas.auth');
Route::post('cancel-pengembalian-artikel', 'artikelController@cancelPengembalianArtikel')->name('cancel-pengembalian')->middleware('cas.auth');
