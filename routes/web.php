...
Route::get('form-new-artikel/{token}/{v_init?}', 'artikelController@formNewArtikel')->name('form-new-artikel')->middleware('auth');
...
Route::post('delete-pengumuman', 'artikelController@deletePengumuman')->name('delete-pengumuman')->middleware('auth');
...
Route::post('prepare-publish', 'artikelController@preparePublish')->name('prepare-publish')->middleware('auth');
...
Route::get('detil-artikel/{id}/{v_init}', 'artikelController@detilArtikel')->name('detil-artikel')->middleware('auth');
...
Route::post('edit-pertanyaan', 'configController@editPertanyaan')->name('edit-pertanyaan')->middleware('auth');
Route::post('update-pertanyaan', 'configController@updatePertanyaan')->name('update-pertanyaan')->middleware('auth');
...
Route::post('update-foto-penulis', 'artikelController@updateFotoPenulis')->name('update-foto-penulis')->middleware('auth');
...
Route::post('hide-artikel', 'artikelController@hideShowArtikel')->name('hide-artikel')->middleware('auth');
Route::post('delete-artikel-draft', 'artikelController@deleteArtikelDraft')->name('delete-artikel-draft')->middleware('auth');
Route::post('remove-artikel', 'artikelController@removeArtikel')->name('remove-artikel')->middleware('auth');
Route::post('delete-config', 'configController@deleteConfig')->name('delete-config')->middleware('auth');
...
Route::get('list-pengguna/{page?}', 'configController@listPengguna')->name('list-pengguna')->middleware('auth');
Route::post('remove-pengguna', 'configController@removePengguna')->name('remove-pengguna')->middleware('auth');
...
//tambah fitur pengembalian artikel
Route::post('form-kembalikan-artikel', 'artikelController@formKembalikanArtikel')->name('form-kembalikan-artikel')->middleware('auth');
