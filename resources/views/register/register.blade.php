<html lang="en">
	...
	<head>
		...
		<link href="{!! asset('../resources/views/assets/css/pages/users/login-1.css') !!}" rel="stylesheet" type="text/css" />
		<link href="
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-row-fluid bg-white" id="kt_login">
				<!--begin::Aside-->
				<div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url({!! asset('../resources/views/assets/media/bg/bg-4.jpg') !!});">
					<!--begin: Aside Container-->
					<div class="d-flex flex-row-fluid flex-column justify-content-between">
						<!--begin: Aside header-->
						<a href="#" class="flex-column-auto mt-5">
							<img src="{!! asset('../resources/views/assets/media/logos/logo-letter-1.png') !!}" class="max-h-70px" alt="" />
						</a>
						<!--end: Aside header-->
						<!--begin: Aside content-->
				...
				<div class="flex-row-fluid d-flex flex-column position-relative p-7 overflow-hidden">
					...
					<div class="position-absolute top-0 right-0 text-right mt-5 mb-15 mb-lg-0 flex-column-auto justify-content-center py-5 px-10">
						...
						<a href="login" class="font-weight-bold ml-2" id="kt_login_signup">Login</a>
					</div>
					<!--end::Content header-->
					<!--begin::Content body-->
					<div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
						...
						<div class="login-form ">
							<div class="text-center mb-10 mb-lg-20">
								...
								<p class="text-muted font-weight-bold">Silahkan masukkan NIP anda</p>
							</div>
							<!--begin::Form-->
							<form action="validate-input">
								@csrf
								<div class="form-group">
									<input class="form-control required form-control-solid h-auto py-5 px-6" type="number" placeholder="NIP" name="nip" autocomplete="off" />
								</div>
		...
		<script src="{!! ('../resources/views/assets/js/scripts.bundle.js') !!}"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Scripts(used by this page)-->
		<!-- <script src="{!! asset('../resources/views/assets/js/pages/custom/login/login.js') !!}"></script> -->
		<script src="{!! asset('../resources/views/assets/js/services.js') !!}"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>